...
using static GD.SysProductos.EN.Compra;
using static GD.SysProductos.EN.Filtros.CompraFiltros;
...
namespace GD.SysProductos.AppWeb.Controllers
{
    public class CompraController : Controller
    {
        ...
        public CompraController(ProveedorBL pProveedorBL, CompraBL pCompraBL, ProductosBL pProductoBL)
        {
